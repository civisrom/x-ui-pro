...
web_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")
sub2singbox_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 6-12 -n 1)")
sub_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")
json_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")
panel_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i с 12-25 -n 1)")
ws_port=$(make_port)
ws_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")web_path
xhttp_path=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")
config_username=$(gen_random_string 10)
config_password=$(gen_random_string 10)
##################################Random Port and Path #################################################
#RNDSTR=$(tr -dc A-Za-z0-9 </dev/urandom | head -c "$(shuf -i 12-25 -n 1)")
#while true; do 
